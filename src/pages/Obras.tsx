...
export default function Obras() {
    return (
        <>
            <SEO
                title="Obras Realizadas - Portafolio de Proyectos | Cielos Americanos Oscar"
                description="Explora nuestro portafolio de obras realizadas en cielos americanos. Proyectos en oficinas, retail y espacios corporativos con instalación profesional y acabados de calidad."
                canonical="https://cieloamericanooscar.cl/obras"
                keywords="obras cielos americanos, portafolio proyectos, instalaciones realizadas, oficinas retail, proyectos chile"
            />
