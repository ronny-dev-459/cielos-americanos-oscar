...
const heroSlides = [
    { src: "/assets/hero/hero-1.webp", alt: "Cielo modular en oficina" },
    { src: "/assets/hero/hero-2.webp", alt: "Tejas de techo modulares" },
    { src: "/assets/hero/hero-3.webp", alt: "Cielos americanos profesionales" },
];
...
export default function Home() {
    ...
    return (
        <>
            <SEO
                title="Cielos Americanos Oscar - Soluciones Profesionales en Cielos Modulares | Santiago, Chile"
                description="Más de 35 años de experiencia en instalación y distribución de cielos modulares, perfilería y luminaria en Santiago, Chile. Cotización rápida por WhatsApp, instalación profesional y materiales certificados."
                canonical="https://cieloamericanooscar.cl"
                keywords="cielos americanos, cielos modulares, perfilería, luminaria, instalación chile, santiago, cielo raso, palmetas metálicas, fibra mineral, instalación profesional"
            />
