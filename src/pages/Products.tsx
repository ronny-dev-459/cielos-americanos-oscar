...
export default function Products() {
    ...
    return (
        <>
            <SEO
                title="Productos - Cielos Modulares, Perfilería y Luminaria | Cielos Americanos Oscar"
                description="Catálogo completo de cielos modulares, perfilería y luminaria. Materiales certificados, instalación profesional y cotización rápida por WhatsApp en Santiago, Chile."
                canonical="https://cieloamericanooscar.cl/productos"
                keywords="catálogo cielos modulares, perfilería cielos, luminaria led, palmetas metálicas, fibra mineral, materiales cielos americanos"
            />
